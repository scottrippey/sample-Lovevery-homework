...
},{"./cjs/react-dom.production.min.js":"i17t"}],"tifz":[function(require,module,exports) {
"use strict";
...
var r = "undefined" != typeof window && void 0 !== window.document && void 0 !== window.document.createElement ? e.useLayoutEffect : e.useEffect,
    n = {
  ...
  var o,
    ...
    return {
      ...
      d = (o = e.useRef(!1), e.useEffect(function () {
    ...
    if (l(t), u instanceof Promise) return v.set(u), f.setLoading(), u.then(function (e) {
      y(u) && f.setResult(e), c.onSuccess(e, {
        isCurrent: function isCurrent() {
          return v.is(u);
        }
      });
    }, function (e) {
      y(u) && f.setError(e), c.onError(e, {
        isCurrent: function isCurrent() {
          return v.is(u);
        }
      });
  ...
  return e.useEffect(function () {
    g ? c.executeOnMount && m.apply(void 0, n) : c.executeOnUpdate && m.apply(void 0, n);
  }, n), t({}, f.value, {
    set: f.set,
    merge: f.merge,
    reset: f.reset,
...
exports.useAsync = i, exports.useAsyncAbortable = function (t, r, n) {
  var u = e.useRef();
  return i(function () {
    ...
    try {
      ...
      return u.current = o, Promise.resolve(function (e, n) {
        try {
          var u = Promise.resolve(t.apply(void 0, [o.signal].concat(r)));
        } catch (e) {
          return n(!0, e);
        }

        return u && u.then ? u.then(n.bind(null, !1), n.bind(null, !0)) : n(!1, value);
      }(0, function (e, t) {
...
}, exports.useAsyncCallback = a, exports.useAsyncFetchMore = function (t) {
  var n,
      u,
      o = t.value,
      s = t.fetchMore,
    ...
    try {
      ...
      return Promise.resolve(s(e.result)).then(function (r) {
        return e.status === l().status && e.result === l().result && y.current === t && (o.merge({
          result: c(o.result, r)
        }), i(r) && v(!0)), r;
      });
    } catch (e) {
...
},{"react":"n8MK"}],"B8X3":[function(require,module,exports) {
'use strict';
...
},{"./react-async-hook.cjs.production.min.js":"tifz"}],"EDTP":[function(require,module,exports) {
'use strict';
...
var messagesServer = axios_1.default.create({
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , messagesServer.get("/messages/" + user)];

          case 1:
            response = _a.sent();
            messages = JSON.parse(response.data.body).message;
            return [2
            /*return*/
            , messages];
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , messagesServer.post('/messages', __assign(__assign({}, newMessage), {
...
},{"axios":"dZBD"}],"pXHl":[function(require,module,exports) {
"use strict";
...
exports.MessagesList = function () {
  ...
  return react_1.default.createElement("div", null, messages.loading && "Loading messages...", messages.error && "Failed to load messages!", !messages.loading && users.length === 0 && "No messages to display", users.map(function (user) {
    var msgs = messages.result[user];
    return react_1.default.createElement("section", {
      key: user
    }, react_1.default.createElement("h1", null, " ", user, " "), msgs.map(function (msg, msgIndex) {
      return react_1.default.createElement("div", {
        key: msgIndex
      }, react_1.default.createElement("h2", null, " ", msg.subject, " "), react_1.default.createElement("p", null, " ", msg.message, " "));
    }));
...
var AddMessage = function AddMessage(_a) {
  ...
  return react_1.default.createElement("div", null, react_1.default.createElement("label", null, " Subject: ", react_1.default.createElement("input", {
    type: "text",
    value: subject,
    onChange: function onChange(e) {
      return setSubject(e.target.value);
    }
  }), " "), react_1.default.createElement("label", null, " Message: ", react_1.default.createElement("input", {
    type: "text",
    value: message,
    onChange: function onChange(e) {
      return setMessage(e.target.value);
    }
  }), " "), react_1.default.createElement("label", null, " User: ", react_1.default.createElement("input", {
    type: "text",
    value: user,
    onChange: function onChange(e) {
...
},{"react":"n8MK","react-async-hook":"B8X3","~/common/messagesClient":"JpP1"}],"HF8J":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=src.a2a860c3.js.map